...
export class YarnTypeController {
    ...
    @Get('')
    @ApiResponse({ status: 200, description: 'data found sucessfully.', type: YarnType, isArray: true })
    ...
    @Post('create')
    @ApiResponse({ status: 200, description: 'Yarn type create sucessfully', type: null, isArray: false })
    ...
    @Put('update')
    @ApiResponse({ status: 200, description: 'Yarn type update sucessfully', type: null, isArray: false })
    ...
    @Delete('remove/:id')
    @ApiResponse({ status: 200, description: 'Yarn type removed sucessfully', type: null, isArray: false })
